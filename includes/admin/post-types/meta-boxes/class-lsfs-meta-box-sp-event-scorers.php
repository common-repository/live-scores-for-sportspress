            ...
            foreach ( $teams as $team_id ) {
                ...
                <div class="lsfs-team-scorers">
                    ...
                    <div class="lsfs-live-scorers-form">
						...
						<div class="lsfs-live-scorers-form-player">
						...
						<div class="lsfs-live-scorers-form-score">
                            <?php
                                ...
                                if ( count( $performances ) === 1 ) {
                                    ...
                                    ?>
                                    <div class="lsfs-live-scorers-form-score-peformance">
                            ...
                            ?>
                            <label for="lsfs_team_player_points_<?php echo esc_attr( $team_id ); ?>">
                                <strong><?php esc_html_e( 'Points', 'live-scores-for-sportspress' ); ?></strong>
                                <input id="lsfs_team_player_points_<?php echo esc_attr( $team_id ); ?>" type="number" name="lsfs_team_player_points" placeholder="<?php _e( 'Enter Points', 'live-scores-for-sportspress' ); ?>" value="1" />
                            </label>

							<label for="lsfs_team_player_minute_<?php echo esc_attr( $team_id ); ?>">
								<strong><?php esc_html_e( 'Minute(s)', 'live-scores-for-sportspress' ); ?></strong>
                        		<input id="lsfs_team_player_minute_<?php echo esc_attr( $team_id ); ?>" type="number" name="lsfs_team_player_minute" placeholder="<?php _e( 'Enter Minute', 'live-scores-for-sportspress' ); ?>" />
							</label>
						</div>
                        <?php do_action( 'lsfs_scorers_form_before_button', $team_id , $post_id ); ?>
						<div class="lsfs-live-scorers-form-score-actions">
