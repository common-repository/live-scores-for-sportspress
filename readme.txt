...
= 1.9.1 - 2021-08-17 =
* Fixes: Escaping output in admin pages for better security.

= 1.9.0 - 2021-08-16 =
* New: When adding a scorer performance, the minutes are now also being stored in box score.
* Fix: Live results would not add 0 to results if it was missing in event lists.
* Fix: Live results would not add 0 to results if it was missing in single event.
* Fix: All performances would be recorded as main one (example: goals) when showing summary. Now it's using only main performance for such listing.
* Fix: Adding a performance should not change the order of players anymore through live scorers.

= 1.8.5 - 2021-05-11 =
* Fix: [Premium] Fixing commentary icons
* Fix: [Premium] Fixing twitter data links

= 1.8.4 - 2021-03-21 =
* Fix: Match results were updated always when adding any scorer performance. Only Primary performance (exp. Goals) will now update the result.
* Fix: [Premium] Adding scorer to commentary was adding it as goal for any performance. Now it uses the correct data.

= 1.8.3 - 2021-03-11 =
* Fix: Error when adding scorers where any performance was saved as goals.
* Update: Licensing Software

= 1.8.2 - 2021-03-11 =
* Fix: Error when adding scorers

= 1.8.1 - 2020-11-17 =
* Update: Scorers Form in admin area has a better styling for easier management.
* Update: Licensing software.
